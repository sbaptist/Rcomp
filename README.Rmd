...
- [`make.R`](https://github.com/sbaptist/Rcomp/tree/main/make.R):
main R script to run the entire project

- [`R/`](https://github.com/sbaptist/Rcomp/tree/main/R):
...
Launch the [`make.R`](https://github.com/sbaptist/Rcomp/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/sbaptist/Rcomp/blob/main/CONTRIBUTING.md).
